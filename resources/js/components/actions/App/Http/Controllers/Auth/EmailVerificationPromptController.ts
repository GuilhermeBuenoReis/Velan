 ...
 * @route '/verify-email'
 */
EmailVerificationPromptController.get = (
  options?: RouteQueryOptions
): RouteDefinition<'get'> => ({
  url: EmailVerificationPromptController.url(options),
  method: 'get',
 ...
 * @route '/verify-email'
 */
EmailVerificationPromptController.head = (
  options?: RouteQueryOptions
 ...
 * @route '/verify-email'
 */
const EmailVerificationPromptControllerForm = (
  options?: RouteQueryOptions
 ...
 * @route '/verify-email'
 */
EmailVerificationPromptControllerForm.get = (
  options?: RouteQueryOptions
): RouteFormDefinition<'get'> => ({
  action: EmailVerificationPromptController.url(options),
  method: 'get',
 ...
 * @route '/verify-email'
 */
EmailVerificationPromptControllerForm.head = (
  options?: RouteQueryOptions
): RouteFormDefinition<'get'> => ({
...
export { EmailVerificationPromptController };
